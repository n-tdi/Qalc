...
public class UtilCommands extends ListenerAdapter {
    ...
    public EmbedBuilder basicMathHelp() {
        ...
        EmbedBuilder help = new EmbedBuilder();
        help.setTitle("Basic Help", "https://discord.gg/VU7kWC9Nda");
        help.setColor(Color.ORANGE);
        help.setAuthor("Qalc Tdi", "https://discord.gg/VU7kWC9Nda", "https://cdn.discordapp.com/avatars/959639967087345674/4fb685544e5f9ce5363336edcf5d5e74.png?size=256");
    ...
    public EmbedBuilder quadraticHelp() {
        ...
        EmbedBuilder help = new EmbedBuilder();
        help.setTitle("Quadratic Help", "https://discord.gg/VU7kWC9Nda");
        help.setColor(Color.ORANGE);
        help.setAuthor("Qalc Tdi", "https://discord.gg/VU7kWC9Nda", "https://cdn.discordapp.com/avatars/959639967087345674/4fb685544e5f9ce5363336edcf5d5e74.png?size=256");
        help.setDescription("Get all the **juicy** info of the quadratic commands here!");
    ...
    public EmbedBuilder physicsHelp() {
        EmbedBuilder help = new EmbedBuilder();
        help.setTitle("Physics Help", "https://discord.gg/VU7kWC9Nda");
        help.setColor(Color.ORANGE);
        help.setAuthor("Qalc Tdi", "https://discord.gg/VU7kWC9Nda", "https://cdn.discordapp.com/avatars/959639967087345674/4fb685544e5f9ce5363336edcf5d5e74.png?size=256");
        help.setDescription("Note gravity is 9.8 m/s^2");
        ...
        String vloc = " [velocity](https://cdn.kastatic.org/ka-perseus-images/ee08cfdce4bdba3844612f517e4daf28803f3c46.png)";
        ...
        String height = " [height](https://cdn1.byjus.com/wp-content/uploads/2020/02/Distance-And-Displacement-2.png)";
